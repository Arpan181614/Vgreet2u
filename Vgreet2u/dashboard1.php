...
<body>
    ...
    <div class="title">
      ...
      <h1>Welcome <?php echo $_SESSION['username']?>, to Vgreet2u</h1>
    </div>
    <div class="par">
    <p class="txt">
    ...
    <div class="btns">
    <a href="logout.php"> <button class='btns_more'> Logout </button></a>
    <a href="my-account.php"> <button class='btns_more'> My Profile </button></a>
    <!--////////////////////////searchIcon////////////////////////-->
    ...
    <li class="menu-item"> <a href="baby.php" onclick="closebabies()">Babies & Kids</a>
